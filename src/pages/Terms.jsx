      ...
      <div className="container page-inner" style={{ maxWidth: '840px', margin: '0 auto' }}>
        ...
        >
          <div style={sectionStyle}>
            <h3 style={headingStyle}>{t('terms.t1')}</h3>
            <p style={paraStyle}>{t('terms.p1')}</p>
          </div>

          <div style={sectionStyle}>
            <h3 style={headingStyle}>{t('terms.t2')}</h3>
            <p style={paraStyle}>{t('terms.p2')}</p>
          </div>

          <div>
            <h3 style={headingStyle}>{t('terms.t3')}</h3>
            <p style={paraStyle}>{t('terms.p3')}</p>
          </div>
        </motion.div>
      </div>
    </div>
